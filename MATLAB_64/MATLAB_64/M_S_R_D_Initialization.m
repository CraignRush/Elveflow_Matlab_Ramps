function [error] = M_S_R_D_Initialization(Device_Name, Sens_Ch_1, Sens_Ch_2, Sens_Ch_3, Sens_Ch_4, MSRD_ID_out)
 % Elveflow Library
 % MSRD Device
 % 
...
error=calllib('Elveflow64', 'M_S_R_D_Initialization' , Device_Name, Sens_Ch_1, Sens_Ch_2, Sens_Ch_3, Sens_Ch_4, MSRD_ID_out);
