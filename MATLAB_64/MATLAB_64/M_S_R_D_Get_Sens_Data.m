function [error] = M_S_R_D_Get_Sens_Data(Channel_1_to_4, M_S_R_D_ID, Sens_Data)
 % Elveflow Library
 % MSRD Device
 % 
...
error=calllib('Elveflow64', 'M_S_R_D_Get_Sens_Data' , Channel_1_to_4, M_S_R_D_ID, Sens_Data);
