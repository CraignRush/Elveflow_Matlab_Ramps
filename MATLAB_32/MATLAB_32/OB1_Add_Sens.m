function [error] = OB1_Add_Sens(OB1_ID, Channel_1_to_4, SensorType, DigitalAnalog, FSens_Digit_Calib, FSens_Digit_Resolution)
 % Elveflow Library
 % OB1 Device
 % 
...
error=calllib('Elveflow32', 'OB1_Add_Sens' , OB1_ID, Channel_1_to_4, SensorType, DigitalAnalog, FSens_Digit_Calib, FSens_Digit_Resolution);
