function [error] = Elveflow_EXAMPLE_PID(PID_ID_in, actualValue, Reset, P, I, PID_ID_out, value)
...
error=calllib('Elveflow32', 'Elveflow_EXAMPLE_PID' , PID_ID_in, actualValue, Reset, P, I, PID_ID_out, value);
